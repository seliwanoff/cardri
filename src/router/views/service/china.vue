...
export default {
  ...
  async mounted() {
    ...
    try {
      const gettransactions = await axios.get(
        `${process.env.VUE_APP_BASE_URL}api/gettransactions?type=35&year=${
          this.y
  ...
  methods: {
      ...
      if (this.day) {
        ...
        try {
          const getUsers = await axios.get(
            `${process.env.VUE_APP_BASE_URL}api/gettransactions?type=35&month=${this.am}&year=${this.y}&page=${this.pageNumber}`
          );
    ...
    async searchByCriteria() {
      try {
        const getUsers = await axios.get(
          `${process.env.VUE_APP_BASE_URL}api/gettransactions?type=35&search=${this.search}`
        );
        this.transactions = getUsers.data.data.data;
        this.totalpage = getUsers.data.data.total;
        this.per_page = getUsers.data.data.per_page;
    ...
    async prev() {
      ...
      try {
        const getUsers = await axios.get(
          `${process.env.VUE_APP_BASE_URL}api/gettransactions?type=35&page=${this.pageNumber}&month=${this.am}&year=${this.y}`,
          {
            headers: {
              Authorization: "Bearer " + this.token,
            },
    ...
    getMonthNumber: async function (m) {
      ...
      try {
        const getUsers = await axios.get(
          `${process.env.VUE_APP_BASE_URL}api/gettransactions?type=35&month=${this.am}&year=${this.y}`
        );
        this.transactions = getUsers.data.data.data;
        this.totalpage = getUsers.data.data.total;
        this.per_page = getUsers.data.data.per_page;
    ...
    async getDaysValue(day) {
      ...
      try {
        const getUsers = await axios.get(
          `${process.env.VUE_APP_BASE_URL}api/gettransactions?type=35&day=${this.day}&month=${this.am}&year=${this.y}`
        );
    ...
    async getYearTransact(year) {
      ...
      if (this.day) {
        ...
        try {
          const getUsers = await axios.get(
            `${process.env.VUE_APP_BASE_URL}api/gettransactions?type=35
