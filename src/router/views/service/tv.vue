    ...
    export default {
      ...
      async mounted() {
        ...
        try {
          const gettransactions = await axios.get(
            `${process.env.VUE_APP_BASE_URL}api/gettransactions?type=3&year=${
              this.y
      ...
      methods: {
        ...
        async getDaysValue(day) {
          ...
          try {
            const getUsers = await axios.get(
              `${process.env.VUE_APP_BASE_URL}api/gettransactions?type=3&day=${this.day}&month=${this.am}&year=${this.y}`
            );
        ...
        async getYearTransact(year) {
          ...
          if (this.day) {
            ...
            try {
              const getUsers = await axios.get(
                `${process.env.VUE_APP_BASE_URL}api/gettransactions?type=3
